-- Eliminar streak_days: la racha va por semanas completadas (weekly_plan_completions), no por días

-- 1. Actualizar get_home_data: quitar streak_days del SELECT y del return
...
-- 2. Eliminar la columna streak_days de profiles
